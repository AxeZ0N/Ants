...
space_renderer = SpaceRenderer(model=model, backend="matplotlib")

renderer = space_renderer.render(agent_portrayal=AgentPortrayal)

comp = []

page = SolaraViz(
    model, renderer, components=comp, model_params=model_params, name="Ants with tests!"
)
